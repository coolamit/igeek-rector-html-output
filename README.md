...
[icon-style]: https://img.shields.io/github/actions/workflow/status/coolamit/igeek-rector-html-output/code-style.yml?branch=master&label=Code%20Style
[icon-tests]: https://img.shields.io/github/actions/workflow/status/coolamit/igeek-rector-html-output/phpunit.yml?branch=master&label=Tests
